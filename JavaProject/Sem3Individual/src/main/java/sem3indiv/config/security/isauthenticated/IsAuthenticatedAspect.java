package sem3indiv.config.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(sem3indiv.config.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(sem3indiv.config.security.isauthenticated.IsAuthenticated)")
